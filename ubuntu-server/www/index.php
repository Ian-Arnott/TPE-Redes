...
.login-button { background: #28a745; }
...
<body>
 ...
 <div class="section">
  ...
  <p>Generate login logs for security alerting tests:</p>
  <a href="login_simulator.php">
   <button class="login-button">🔐 Login Log Simulator</button>
  </a>
 </div>
